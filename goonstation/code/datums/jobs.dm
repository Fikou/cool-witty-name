...
/datum/job/engineering/construction_worker_safe
	name = "Construction Worker"
	allow_traitors = 0
	cant_spawn_as_rev = 1
	limit = 1
	...
	items_in_backpack = list(/obj/item/tank/emergency_oxygen, /obj/item/rcd/rcd_safe, /obj/item/rcd_ammo/big, /obj/item/rcd_ammo/big)
...
/datum/job/special/syndicate_NPC
	linkcolor = "#C74444"
	name = "Atmospheric Technician"
	limit = 0
	allow_traitors = 1
	allow_spy_theft = 0
	recieves_implant = /obj/item/implant/microbomb
	slot_back = /obj/item/storage/backpack
	slot_belt = /obj/item/storage/belt/utility/prepared
	slot_jump = /obj/item/clothing/under/misc/atmospheric_technician
	slot_suit = /obj/item/clothing/suit/hi_vis
	slot_head = /obj/item/clothing/head/helmet/hardhat
	slot_foot = /obj/item/clothing/shoes/brown
	slot_ears = /obj/item/device/radio/headset/syndicate
	slot_mask = /obj/item/clothing/mask/gas
	slot_card = /obj/item/card/id/syndicate/terra8
	slot_eyes = /obj/item/clothing/glasses/meson
	slot_poc1 = /obj/item/knife
	slot_poc2 = /obj/item/device/flash
	slot_lhan = /obj/item/device/analyzer/atmospheric
	items_in_backpack = list(/obj/item/extinguisher,
	/obj/item/device/glowstick)

	para_eng
		slot_head = /obj/item/clothing/head/helmet/welding
		slot_suit = /obj/item/clothing/suit/bio_suit/paramedic/armored/para_eng
		slot_belt = /obj/item/gun/kinetic/flaregun
		slot_mask = /obj/item/clothing/mask/cigarette
		slot_poc1 = /obj/item/ammo/bullets/flare
		slot_poc2 = /obj/item/storage/pouch/bullet_9mm
		items_in_backpack = list(/obj/item/device/flashlight,/obj/item/gun/kinetic/pistol,/obj/item/cell/cerenkite)
	...
	security
		...
		para_sec
			slot_back = /obj/item/storage/backpack/NT
			slot_belt = /obj/item/gun/kinetic/smg
			slot_jump = /obj/item/clothing/under/misc/turds
			slot_suit = /obj/item/clothing/suit/bio_suit/paramedic/armored/para_troop
			slot_head = /obj/item/clothing/head/NTberet
			slot_foot = /obj/item/clothing/shoes/swat
			slot_mask = /obj/item/clothing/mask/gas
			slot_eyes = /obj/item/clothing/glasses/nightvision
			slot_poc2 = /obj/item/storage/pouch/bullet_9mm
	...
	botany
		...
		slot_back = /obj/item/storage/backpack/satchel
		slot_belt = /obj/item/gun/kinetic/pistol
		slot_jump = /obj/item/clothing/under/misc/hydroponics
		slot_suit = /obj/item/clothing/suit/wintercoat/research
		slot_head = /obj/item/clothing/head/cowboy
		slot_mask = /obj/item/clothing/mask/gas/injector_mask
		slot_eyes = /obj/item/clothing/glasses/spectro
		slot_poc2 = /obj/item/storage/pouch/bullet_9mm
...
/datum/job/special/ntso_specialist
	...
	slot_mask = /obj/item/clothing/mask/breath
	slot_card = /obj/item/card/id/command
	slot_poc1 = /obj/item/storage/pouch/powercell_medium
	slot_poc2 = /obj/item/storage/pouch/bullet_9mm
	items_in_backpack = list(/obj/item/gun/energy/ntgun,
							/obj/item/device/pda2/heads,
							/obj/item/old_grenade/stinger/frag,
...
/datum/job/special/ntso_specialist_weak
	...
	slot_poc2 = /obj/item/storage/pouch/clock
