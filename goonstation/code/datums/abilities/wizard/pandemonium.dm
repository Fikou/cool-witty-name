/datum/targetable/spell/pandemonium
	...
	cast()
		...
		if(O && istype(O.wear_suit, /obj/item/clothing/suit/wizrobe/necro) && istype(O.head, /obj/item/clothing/head/wizard/necro))
			playsound(holder.owner.loc, "sound/voice/wizard/PandemoniumGrim.ogg", 50, 0, -1)
		else if(holder.owner.gender == "female")
			playsound(holder.owner.loc, "sound/voice/wizard/PandemoniumFem.ogg", 50, 0, -1)
		else
...
/mob/living/carbon/human/proc/PAND_Signaljam(var/protectuser = 1)//wtf.
