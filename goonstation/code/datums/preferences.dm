...
*/
	...
	proc/ShowChoices(mob/user)
		...
		LAGCHECK(LAG_HIGH)
		//mbc is sorry
		var/header_thing_chui_toggle = (user.client && !user.client.use_chui) ? "<html><head><meta http-equiv=\"X-UA-Compatible\" content=\"IE=8\"/><meta http-equiv=\"pragma\" content=\"no-cache\" /></head><body>" : ""
		dat += {"([header_thing_chui_toggle]<title>Character Setup</title>

					<b>Profile Name:</b>
					<a href=\"byond://?src=\ref[user];preferences=1;profile_name=input\"><b>[src.profile_name ? src.profile_name : "Unnamed"]</b></a>

					<hr><b>Character Name (First/Middle/Last):</b>"}
		dat += script
		dat += "<br><a href=\"byond://?src=\ref[user];preferences=1;first_name=input\"><b>[length(src.name_first) ? src.name_first : "_"]</b></a> "
		dat += "<a href=\"byond://?src=\ref[user];preferences=1;middle_name=input\"><b>[length(src.name_middle) ? src.name_middle : "_"]</b></a> "
		dat += "<a href=\"byond://?src=\ref[user];preferences=1;last_name=input\"><b>[length(src.name_last) ? src.name_last : "_"]</b></a> "
		dat += {"<br><b>Random name? </b>
					(&reg; = <a href=\"byond://?src=\ref[user];preferences=1;b_random_name=1\">[src.be_random_name ? "Yes" : "No"]</a>)
					<br>

					<b>Random appearance? </b>
					(&reg; = <a href=\"byond://?src=\ref[user];preferences=1;b_random_look=1\">[src.be_random_look ? "Yes" : "No"]</a>)
					<br>

					<b>Gender:</b> <a href=\"byond://?src=\ref[user];preferences=1;gender=input\"><b>[display_gender]</b></a><br>
					<b>Age:</b> <a href='byond://?src=\ref[user];preferences=1;age=input'>[src.age]</a><br>
					<b>Blood Type:</b> <a href='byond://?src=\ref[user];preferences=1;blType=input'>[src.random_blood ? "Random" : src.blType]</a><br>
					<b>Bank PIN:</b> <a href='byond://?src=\ref[user];preferences=1;pin=input'>[src.pin ? src.pin : "Random"]</a> (<a href=\"byond://?src=\ref[user];preferences=1;random_pin=1\">&reg;</a>)<br>
					<b>Flavor Text:</b> <a href='byond://?src=\ref[user];preferences=1;flavor_text=input'><small>[length(src.flavor_text) ? src.flavor_text : "None"]</small></a><br>
					<br>
					<b>Security Note:</b> <a href='byond://?src=\ref[user];preferences=1;security_flavor_text=input'><small>[length(src.security_note) ? src.security_note : "None"]</small></a><br>
					<b>Medical Note:</b> <a href='byond://?src=\ref[user];preferences=1;medical_flavor_text=input'><small>[length(src.medical_note) ? src.medical_note : "None"]</small></a><br>

					<b>Fart Sound:</b> <a href='byond://?src=\ref[user];preferences=1;fartsound=input'>[AH.fartsound]</a><br/>
					<b>Scream Sound:</b> <a href='byond://?src=\ref[user];preferences=1;screamsound=input'>[AH.screamsound]</a><br/>
					<b>Chat Sound:</b> <a href='byond://?src=\ref[user];preferences=1;voicetype=input'>[AH.voicetype]</a><br/>
					<b><a href=\"byond://?src=\ref[user];preferences=1;jobswindow=1\">Occupation Choices</a>[ favoriteJob ? " (Fav: [favoriteJob])" : "" ]</b><br>
					<b><a href=\"byond://?src=\ref[user];preferences=1;traitswindow=1\">Trait Choices</a></b>
					<hr>
					<table><tr><td>
					<b>Appearance:</b><br>"}

		if (AH)
			dat += {"<a href='byond://?src=\ref[user];preferences=1;s_tone=input'><b>Skin Tone:</b></a> <font face='fixedsys' size='3' color='[AH.s_tone]'><b>#</b></font></a><br>

					<a href='byond://?src=\ref[user];preferences=1;eyes=input'><b>Eye Color:</b> <font face='fixedsys' size='3' color='[AH.e_color]'><b>#</b></font></a><br>"}
			...
			dat += "</td><td>"
			dat += {"
					<center><b>Preview</b>:<br>
					<img style=\"-ms-interpolation-mode:nearest-neighbor;\" src=previewicon.png id='sprite_preview' height=64 width=64><br>
					<a href=\"byond://?src=\ref[user];preferences=1;rotate_counter_clockwise=1\">&#x27f2;</a>
					<a href=\"byond://?src=\ref[user];preferences=1;rotate_clockwise=1\">&#x27f3;</a>
					</center>"}
		...
		if ((user && ismob(user)) && user.client && user.client.is_mentor()) // undefined variable /client/var/client
		...
		switch(tooltip_option)
			if(TOOLTIP_ALWAYS)
				tooltipStr = "Show always"
			if(TOOLTIP_NEVER)
				tooltipStr = "Disabled"
			if(TOOLTIP_ALT)
				tooltipStr = "Show on (ALT)"
			else tooltipStr = "???"
		...
		dat += {"<b>HUD style: <a href =\"byond://?src=\ref[user];preferences=1;hud_style=1\"><img style=\"-ms-interpolation-mode:nearest-neighbor;\" src=hud_preview.png></a></b> |
				<b>Targeting cursor: <a href =\"byond://?src=\ref[user];preferences=1;tcursor=1\"><img style=\"-ms-interpolation-mode:nearest-neighbor;\" src=tcursor.png></a></b><br>
				<b>Display OOC chat?</b> <a href=\"byond://?src=\ref[user];preferences=1;listen_ooc=1\">[(src.listen_ooc ? "Yes" : "No")]</a></b><br>
				<b>Display LOOC chat?</b> <a href=\"byond://?src=\ref[user];preferences=1;listen_looc=1\">[(src.listen_looc ? "Yes" : "No")]</a></b><br>
				<b>View Changelog Automatically?: <a href =\"byond://?src=\ref[user];preferences=1;changelog=1\">[(src.view_changelog ? "Yes" : "No")]</a></b><br>
				<b>View Score Info Automatically?: <a href =\"byond://?src=\ref[user];preferences=1;scores=1\">[(src.view_score ? "Yes" : "No")]</a></b><br>
				<b>View Tickets/Fines Automatically?: <a href =\"byond://?src=\ref[user];preferences=1;tickets=1\">[(src.view_tickets ? "Yes" : "No")]</a></b><br>
				<b>Queue Combat Clicks?: <a href =\"byond://?src=\ref[user];preferences=1;clickbuffer=1\">[(src.use_click_buffer ? "Yes" : "No")]</a></b><br>
				<b>Admin Music Volume: <a href =\"byond://?src=\ref[user];preferences=1;volume=1\">[src.admin_music_volume]</a></b><br>
				<b>Radio Music Volume: <a href =\"byond://?src=\ref[user];preferences=1;radio=1\">[src.radio_music_volume]</a></b><br>
				<b>Tooltip style: <a href =\"byond://?src=\ref[user];preferences=1;tooltip=1\">[tooltipStr]</a></b><br>
				<b>Use WASD Mode?: <a href =\"byond://?src=\ref[user];preferences=1;use_wasd=1\">[(src.use_wasd ? "Yes" : "No")]</a></b><br>
				<b>Use AZERTY Layout?: <a href =\"byond://?src=\ref[user];preferences=1;use_azerty=1\">[(src.use_azerty ? "Yes" : "No")]</a></b><br>
				<b>Preferred map?: <a href =\"byond://?src=\ref[user];preferences=1;preferred_map=1\">[(length(src.preferred_map) ? src.preferred_map : "None")]</a></b><hr>"}

		LAGCHECK(LAG_REALTIME)
		if (user && !IsGuestKey(user.key)) //ZeWaka: Fix for null.key
			dat += "<b>Save Profile:</b>"
			for (var/i=1, i <= SAVEFILE_PROFILES_MAX, i++)
				dat += " <a href='byond://?src=\ref[user];preferences=1;save=[i]'>[savefile_get_profile_name(user, i) || i]</a>"
				LAGCHECK(LAG_REALTIME)
			dat += "<br>"
			...
			for (var/i=1, i <= SAVEFILE_PROFILES_MAX, i++)
				...
				LAGCHECK(LAG_REALTIME)
			dat += "<br><b>Cloud Saves</b><br/>"
			var/client/wtf = ismob( user ) ? user.client : user
			for( var/name in wtf.cloudsaves )
				dat += " <a href='byond://?src=\ref[user];preferences=1;cloudload=[url_encode(name)]'>Load [html_encode(name)]</a> "
				LAGCHECK(LAG_REALTIME)
			dat += "<br/><hr/>"
			for( var/name in wtf.cloudsaves )
				dat += "<a href='byond://?src=\ref[user];preferences=1;cloudsave=[url_encode(name)]'>Save over [html_encode(name)]</a> <a href='byond://?src=\ref[user];preferences=1;clouddelete=[url_encode(name)]'><sup>(del)</sup></a> "
				LAGCHECK(LAG_REALTIME)
			dat += "<br/><b><a href='byond://?src=\ref[user];preferences=1;cloudnew=1'>New Cloud Save</a></b><br/>"


		dat += {"<br/><a href='byond://?src=\ref[user];preferences=1;reset_all=1'><b>Reset</b></a> -
		<a href='byond://?src=\ref[user];preferences=1;real_name=random'><b>Randomize</b></A><br>
		"}
		...
		user.Browse(dat.Join(),"window=preferences;size=333x615;title=Preferences")
...
// -------------------------------------------
		...
		if (link_tags["tooltip"])
			switch(tooltip_option)
				if(TOOLTIP_ALWAYS)
					tooltip_option = TOOLTIP_NEVER
				if(TOOLTIP_NEVER)
					tooltip_option = TOOLTIP_ALT
				if(TOOLTIP_ALT)
					tooltip_option = TOOLTIP_ALWAYS
				else tooltip_option = TOOLTIP_ALWAYS
