...
var/global/list/mapNames = list(
	...
	"Donut 2" = 		list("id" = "DONUT2", 		"settings" = "donut2"),
	"Horizon" = 		list("id" = "HORIZON", 		"settings" = "horizon", 		"playerPickable" = 1), // John Warcrimes' map
	"Linemap" = 		list("id" = "LINEMAP", 		"settings" = "linemap"), // pgoat's map
	"Mushroom" =		list("id" = "MUSHROOM", 	"settings" = "mushroom"),
	"Trunkmap" = 		list("id" = "TRUNKMAP", 	"settings" = "trunkmap"),
	"Oshan Laboratory"= list("id" = "OSHAN", 		"settings" = "oshan", 			"playerPickable" = 1),
	//"Samedi" = list("id" = "SAMEDI", "settings" = "samedi", "playerPickable" = 1),
