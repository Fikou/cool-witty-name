...
/datum/mutantrace/kudzu
	...
	l_limb_type_mutantrace = /obj/item/parts/human_parts/arm/left/synth
	r_limb_type_mutantrace = /obj/item/parts/human_parts/arm/right/synth
