...
/obj/machinery/seaheater
	...
	New()
		mantaHeaters.Add(src)
		. = ..()
	Del()
		mantaHeaters.Remove(src)
		return ..()
...
/obj/miningteleporter
	...
	proc/teleport(mob/user)
		for(var/obj/miningteleporter/S) // in world AUGHHH
...
/obj/machinery/reliquaryscout
	...
	icon = 'icons/obj/reliquary_critters.dmi'
	icon_state = "scoutbot"
