...
/obj/item/paper/satviewX08
	name = "radar imagery"
	desc = "It's marked 'SURVEY X08 RADSAT'. Looks like a printed-out view of some structures on a nearby moon's surface."
	icon = 'icons/misc/terra8.dmi'
	icon_state = "satviewX08"
	...
	New()
		...
		pixel_x = rand(-8, 8)
		pixel_y = rand(-8, 8)
		info = "<html><body style='margin:0px'><img src='[resource("images/radioTelescope/satviewX08.png")]'></body></html>"
...
/obj/item/storage/secure/ssafe/pilot_cargo1
	...
	configure_mode = 0
	random_code = 1
	spawn_contents = list(/obj/item/paper/requisitionF49A,
	/obj/item/paper/satviewX08, // a thing to confuse people
	/obj/item/clothing/glasses/regular, /obj/item/zippo/gold)
...
/area/terraeight
	...
	fog
		ambient_light = "#335555"
		icon_state = "white"
		sound_environment = 15

		/*New()
			..()
			overlays += image(icon = 'icons/misc/terra8.dmi', icon_state = "bluefog", layer = EFFECTS_LAYER_BASE)*/

		ground

			desc = "A deep jagged valley with dark rock spires rising through the low cloud layer."
			...
			lv4
				name = "level 4"
				desc = "You're fairly high up."

			lv5
				name = "level 5"
				desc = "You're really high up. Probably. Can't see a thing through these clouds."
...
/turf/unsimulated/wall/adaptive/concrete
	...
	desc = "A composite poured concrete mixed from mined regolith and locally excavated rocky debris."


/turf/unsimulated/wall/setpieces/bunker_window
	name = "bunker window"
	icon = 'icons/misc/terra8.dmi'
	icon_state = "slot_window"
	fullbright = 0
	opacity = 0
	desc = "A highly reinforced observation slot in the concrete wall."


/turf/unsimulated/wall/setpieces/bunker_grille
	name = "reinforced grille"
	icon = 'icons/misc/terra8.dmi'
	icon_state = "grille-burly"
	fullbright = 0
	opacity = 0
	desc = "A highly reinforced and rugged wall of metal slats."

	cap
		icon_state = "grille-burly-cap"

/turf/unsimulated/floor/concrete
	name = "concrete floor"
	desc = "It's pretty sturdy."
	icon = 'icons/misc/terra8.dmi'
	icon_state = "floor"

/turf/unsimulated/floor/moss
	name = "moss"
	desc = "A deep mat of lichens and mosses."
	icon = 'icons/misc/terra8.dmi'
	icon_state = "moss"
...
/turf/unsimulated/wall/setpieces/clouds
	name = "dense clouds"
	desc = "Dense mists obscure your view."
	icon = 'icons/misc/terra8.dmi'
	icon_state = "bluefog"

/turf/unsimulated/floor/setpieces/clouds
	name = "swirling clouds"
	desc = "Deep swirling mists."
	icon = 'icons/misc/terra8.dmi'
	icon_state = "bluefog"

/turf/unsimulated/floor/setpieces/pitchblack
	name = "deep darkness"
	icon = 'icons/misc/worlds.dmi'
	desc = "It goes down pretty far."
	icon_state = "black"

/obj/machinery/door/poddoor/bunker
	name = "bunker lock"
	icon = 'icons/misc/terra8.dmi'
	desc = "A seriously heavy blast door."
	icon_state = "pdoor1"
	adaptable = 1
	mats = 0
...
/obj/machinery/door/airlock/bunker
	...
	attackby(var/obj/item/W, var/mob/user)
		if (isscrewingtool(W))
			boutput(user, "<span style=\"color:red\">There don't seem to be any accessible parts on this.</span>")
			return 0
		. = ..()
...
/mob/living/carbon/human/secret/crazed
	real_name = "radio operator"
	gender = MALE
	//before launch, probably should move these strings over to txt file
	var/list/lines = list("You're listening to The Hubbub...","Today's advice column: don't go downstairs...","Condition orchid, condition orchid...", "Stay tuned... stay tuned...",
	"Today's weather coming up next...","...is today's weather? Today?", "Where did they all go...", "Are we live...?","Buy space gold! It's fine!","Were YOU injured on YOUR station? Call the Law Offices of Hogg and Wylde today...",
	"Today's special guests came a long way to be here...","Quiet, quiet, we're live...","Today on Botany Hour, we'll learn about the orchid... orchid...","She knows...",
	"Space traffic report up next...","Help...","Is someone here...","Signal lost...lost...","They'll be here soon...","Stay out, stay out...",
	"Today's traffic is... I...","Take a vacation to lovely Station 17 today...","Testing... testing... 1...","Why are you here...","You shouldn't be here...","Can you hear them?","Sad news from the Janitors' Union Jamboree...",
	"Can they see you too?","So loud, so loud...","You're listening...","I'm your host... your...","They're listening...","Bad news from Station 12, folks...",".........",".....","Songs for Robuddies, later tonight...",
	"Did you hear about Station 6?","The moon is fine...","We're brought to you by Grones...?","Eat Dan's... it's...","Fire reported at Orbital Trade Outpost 29...","Structural collapse reported at Habitation Seven-B...",
	"It hurts...","Call in today with tips for Gossip Hour...","Station 13 caught in scandal today...","Nanotrasen Cares...","Ask your quartermaster today for your free sample of Swole Cat, It's Fine!","...",
	"Is YOUR station the best? Tell us all about it, callers, for a chance to win...","I'm... where was I?","Today's lucky numbers are all sevens...","Nanotrasen stocks fell fifteen points today...","Remember, Safety First...","Our guests are here...","They're all talking, singing...")

	New()
		..()
		SPAWN_DBG(0)
			JobEquipSpawned("Engineer")
			bioHolder.mobAppearance.customization_second = "Watson"
			bioHolder.mobAppearance.underwear = "briefs"
			bioHolder.AddEffect("quiet_voice")
			wear_suit = new /obj/item/clothing/suit(src)
	...
	Life(datum/controller/process/mobs/parent)
		...
		if (prob(3) && !src.stat)
			say(pick(lines))
		if(prob(1) && !src.stat)
			SPAWN_DBG(0) src.emote(pick("panic","pale","ponder","tremble","quiver","shiver","shudder","shake","weep","cry","wail","twitch"))

///// RESPONSE TEAM
/mob/living/carbon/human/npc/terra8
	unobservable = 1
	ai_aggressive = 1
	var/agent_type = "para-sec"
	...
	Life(datum/controller/process/mobs/parent)
		...
		if(prob(1) && !src.stat)
			SPAWN_DBG(0) src.emote(pick("frown","flex","knuckles","glare","stare","shakehead","point","signal"))
...
/obj/decal/fakeobjects/terra8
	name = "industrial atmospherics machinery"
	desc = "Large volume air-handling equipment."
	...
	cabinets
		...
		desc = "An array of complicated atmospherics controls and readouts. The system seems to be locked in a minimal power routine."
		icon_state = "cab1"
		density = 1
	...
	indicators
		icon = 'icons/obj/atmospherics/pipes.dmi'
		icon_state = "meterX"
		name = "atmospherics indicators"
		desc = "What do they mean? Who knows? An atmos tech would probably know."

	vines
		name = "vines"
		desc = "Seems to be related to space kudzu."
		icon = 'icons/misc/terra8.dmi'
		icon_state = "vines"
		alpha = 200
...
/obj/item/stamp/classified
		...
		desc = "For important classified documents."
		icon_state = "stamp-hos"
		is_reassignable = 0
		assignment = "CLASSIFIED"

/obj/item/card/id/syndicate/terra8
	name = "facility access card"
	desc = "Pretty much a standard-ish access card."
	access = list(access_maint_tunnels, access_syndicate_shuttle,access_syndicate_16)
	registered = "00000"
	assignment = "Technician"


	// give these all a bunch of specific character numbers soon

	/* style guide adapted from Wire/Marquesas terminal lore

	NT/ADMIN administrative level
	NT/ADMIN/SCI research directors
	NT/SEC security
	NT/SEC/CORP corporate security
	NT/SEC/FORN forensics
	NT/SEC/CORP/PHYS interrogators
	NT/PROD/SCI research
	NT/PROD/SCI/AM anomalous materials

	NT/ENG - surface techs
	NT/BIO  - surface botanists


	security ranks
	SEC/4 - station traitors
	SEC/8 - nuke ops
	SEC/16 - nuke commanders?
	CORE/32 - something higher than those jerks
	CORE/64  - minimum required for access to syndicate section of bunker
	CORE/96
	CORE/128
	CORE/192
	CORE/254 ? ?
	CORE/256
	CORE/512   - never ever implement this, just allude to it



	access_syndicate_4 = 60
	access_syndicate_8 = 61
	access_syndicate_16 = 62
	access_syndicate_32 = 63
	access_syndicate_64 = 64 // level needed for access to terra8 underside
	access_syndicate_128 = 65
	access_syndicate_256 = 66 // highest level documents in terra8
	access_syndicate_512 = 67 // allude to this but don't use it except for super special things
	...
	*/
	...
	security // redshirts
		registered = "00001"
		assignment = "NT/SEC"
		access = list(access_syndicate_shuttle,access_syndicate_16,access_syndicate_32)


		corp // enforcers? tuffs?
			assignment = "NT/SEC/CORP"
			access = list(access_syndicate_shuttle,access_syndicate_16,access_syndicate_32,access_syndicate_64)

		commander
			assignment = "NT/ADMIN/SEC"
			access = list(access_syndicate_shuttle,access_syndicate_16,access_syndicate_32,access_syndicate_64,access_syndicate_128)

		eng
			assignment = "NT/SEC/ENG"
			access = list(access_syndicate_shuttle,access_syndicate_16, access_syndicate_32, access_engineering)

	research
		registered = "00002"
		assignment = "NT/PROD/SCI"
		access = list(access_syndicate_shuttle,access_syndicate_16,access_syndicate_32,access_syndicate_64,access_syndicate_128)

		director
			registered = "00004"
			assignment = "NT/ADMIN/SCI"
			access = list(access_syndicate_shuttle,access_syndicate_16,access_syndicate_32,access_syndicate_64,access_syndicate_128,access_syndicate_256)

		anomalous
			registered = "00003"
			assignment = "NT/PROD/SCI/AM"
			access = list(access_syndicate_shuttle,access_syndicate_16,access_syndicate_32,access_syndicate_64,access_syndicate_128)
...
/obj/critter/shade/dread
	...
	guardian
		name = "!!!!"
		desc = "Oh good, this one has some kinda swords. Great."
		icon_state = "dread_swords"
		health = 2000
	...
	elder
		name = "****"
		desc = "Oh. Well that's a problem."
		icon_state = "dread_elder0"
		health = 6666
