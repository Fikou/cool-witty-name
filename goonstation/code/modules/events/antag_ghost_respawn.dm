/datum/random_event/major/antagonist
	...
	admin_call(var/source)
		...
		var/type = input(usr, "Select antagonist type.", "Antagonists", "Blob") as null|anything in list("Blob", "Blob (AI)", "Wraith", "Wizard", "Werewolf", "Hunter")
		if (!type)
			return
		else
	...
	event_effect(var/source)
		...
		switch (src.antagonist_type)
			if ("Blob", "Blob (AI)")
				...
				src.centcom_message = "Our [pick("probes", "sensors", "listening devices", "informants", "well-informed sources")] indicate the presence of a hostile intruder aboard the [station_or_ship()]. Security level elevated."
