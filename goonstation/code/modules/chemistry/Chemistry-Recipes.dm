...
*/
		...
		*/
		...
		king_readsterium
			...
			id = "badmanjuice"
			result = "badmanjuice"
			required_reagents = list("transparium" = 1, "glitter" = 1, "port" = 1, "cholesterol" = 1 ) //Im assuming this will be made secret please change this recipe this is for testing purposes only.
			result_amount = 1
			mix_phrase = "The mixture swirls becoming blue, you can hear faint music emanating from it."
			mix_sound = 'sound/misc/drinkfizz.ogg'
