...
datum
	reagent
		...
		ice
			...
			fluid_b = 250
			transparency = 200
			thirst_value = 3 // changed to be the same as water because apparently this was causing people to die of thirst or something??  ice cream: the deadliest weapon
			taste = "cold"
