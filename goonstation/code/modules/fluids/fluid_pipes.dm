...
var/global/obj/fluid_pipe/list/all_fluid_pipes = list()
var/global/datum/flow_network/list/all_fluid_networks = list()
...
/obj/fluid_pipe
	...
	var/obj/fluid_pipe/list/edges = list()
...
/datum/flow_network
	var/obj/fluid_pipe/list/nodes = list()
	var/obj/fluid_pipe/list/sources = list()
	var/obj/fluid_pipe/list/sinks = list()
...
proc/ford_fulkerson(var/datum/flow_network/FN)
	var/obj/fluid_pipe/list/path = list()
	FN.clear_DFS_flags()
...
proc/find_augmenting_path(var/datum/flow_network/FN)
	...
	var/obj/fluid_pipe/list/stack = list()
...
proc/find_source_sink_path(var/obj/fluid_pipe/source, var/obj/fluid_pipe/list/stack)
	// Push self
	stack.Add(source)
...
proc/flow_through(var/obj/fluid_pipe/list/path, max_allowed_flow)
