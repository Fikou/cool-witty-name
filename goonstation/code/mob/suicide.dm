...
/mob/living/silicon/robot/do_suicide()
	...
	SPAWN_DBG(20)
		R.emote("scream")
	SPAWN_DBG(30)
		src.visible_message("<span style=\"color:red\"><b>[src] has torn off its head!</b></span>")
...
/mob/living/silicon/ghostdrone/do_suicide()
	src.visible_message("<span style=\"color:red\"><b>[src] forcefully rips it's own soul from it's body!</b></span>")
	src.unlock_medal("Damned", 1)
	src.death()
