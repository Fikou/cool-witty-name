...
/mob/living/silicon/ai/New(loc, var/empty = 0)
	...
	SPAWN_DBG(0)
		...
		src.radio3.name = "Frequency Monitoring Radio"
...
/mob/living/silicon/ai/show_text(var/message, var/color = "#000000", var/hearing_check = 0, var/sight_check = 0, var/allow_corruption = 0)
	..()
	if (deployed_to_eyecam && src.eyecam)
		src.eyecam.show_text(message, color, 0, sight_check, allow_corruption)
	return
