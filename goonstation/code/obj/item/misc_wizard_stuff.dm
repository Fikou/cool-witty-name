	...
	proc/do_brainmelt(var/mob/affected_mob, var/severity = 2)
		...
		switch (severity)
			if (0)
				...
				affected_mob.changeStatus("weakened", 1 SECONDS)
			...
			if (1)
				...
				affected_mob.changeStatus("paralysis", 2 SECONDS)
				affected_mob.stuttering += 10
				affected_mob.changeStatus("weakened", 5 SECONDS)
				...
				affected_mob.take_brain_damage(50)
