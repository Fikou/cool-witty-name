...
/obj/item/pipebomb/frame
	...
	var/list/allowed_items = list("/obj/item/device/glowstick","/obj/item/clothing/head/butt", "/obj/item/paper", "/obj/item/reagent_containers/food/snacks/ingredient/meat",\
			...
			for (var/M in item_mods)
				for (var/I in allowed_items)
					if (istype(M, text2path(I) ))
						...
						if (istype(M, /obj/item/device/glowstick))
							A.glowsticks += 1
