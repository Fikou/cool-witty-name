...
/obj/item/storage/wall/random
	...
	make_my_stuff()
		...
		if (ispath(thing1))
			new thing1(src)
		var/thing2 = pick(10;/obj/item/device/radio, 4;/obj/item/device/radio/signaler, 30;/obj/item/device/glowstick, 15;/obj/item/device/flashlight, 1;/obj/item/device/multitool)
		if (ispath(thing2))
			new thing2(src)
