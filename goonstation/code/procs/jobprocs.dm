...
/mob/living/carbon/human/proc/Equip_Job_Slots(var/datum/job/JOB)
	...
	if (src.traitHolder && src.traitHolder.hasTrait("pawnstar"))
		...
		trinket = new/obj/item/zippo(src)
	else
		trinket = new T(src)
...
/obj/item/instrument/vuvuzela, /obj/item/wrench, /obj/item/zippo, /obj/item/reagent_containers/food/drinks/bottle/beer, /obj/item/reagent_containers/food/drinks/bottle/vintage,
