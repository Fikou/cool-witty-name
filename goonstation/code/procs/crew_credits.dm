...
/chui/window/crew_credits
	...
	GetBody()
		...
		var/datum/mind/list/round_antags = list()
		var/datum/mind/list/round_captains = list()
		var/datum/mind/list/round_security = list()
		var/datum/mind/list/round_medical = list()
		var/datum/mind/list/round_science = list()
		var/datum/mind/list/round_engineering = list()
		var/datum/mind/list/round_civilian = list()
		var/datum/mind/list/round_other = list()
...
proc/generate_crew_photo(var/background_icon, var/background_icon_state, var/datum/mind/list/chars, var/photo_name)
	...
	var/icon/list/photo_rows = split_into_photo_rows(chars,chars_per_line)
	// Tile the background
...
proc/split_into_photo_rows(var/datum/mind/list/chars, var/max_per_row)
